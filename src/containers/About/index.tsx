  ...
  return (
    <React.Fragment>
      <div className="about slide-1 background-light flex flex__column">
        ...
        <p>
          I am a full-stack JavaScript developer. I also dabble with Flutter and
          Dart for cross-platform native apps. I am currently obsessed with
          micro-services.
        </p>
      </div>
      <div className="about slide-2 background-dark flex flex__column">
        ...
        <p>
          <span className="display__block">-</span>
          <span className="display__block">
            I can automate workflows (CI/CD) and promote Agile processes with 2
            tools
          </span>
          <span className="display__block">
      ...
      <div className="about slide-3 background-light flex flex__column">
        ...
        <p>
          <span className="display__block">-</span>
          <span className="display__block">
            I work mainly on building micro-services, or APIs, with JavaScript,
            Typescript, and Python for MicroAPI. MicroAPI is an idea where API
            become the new packages. As a JavaScript developer, I use NPM a lot.
            Not disregarding the value of NPM, MicroAPI aims to make APIs easily
            installable through one kind of API manager - MicroAPI. The MicroAPI
        ...
        <p>
          ...
          <span className="display__block">
            I practice Agile processes with my remote team with GitHub Projects,
            Issues, Slack, and Zoom,
          </span>
          <span className="display__block">
      ...
      <div className="about slide-4 background-dark flex flex__column">
        ...
        <p>
          ...
          <span className="display__block">
            I went to the University of Cape Town for 1 year. During the time, I
        ...
        <p>
          ...
          <span className="display__block">
            I started as an HNG intern in July and now I am a core maintainer of
            one the startups (MicroAPI) that stemmed out of the internship.
          </span>
        </p>
      </div>
    </React.Fragment>
